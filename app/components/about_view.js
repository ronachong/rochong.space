...
const AboutView = (props) => (
    <section style={styles.aboutContainer} >
        ...
        <p>Prior to Holberton School, I got my Bachelor's of Art in sociology from Pomona College and graduated from Scripps, The Women's/Non-normative Gender Identities College (slightly tongue-in-cheek, but still serious). LA/Inland Empire is like a second home to me! After the Central Valley, the area I grew up in, and San Francisco, which serves as my current, albeit overly-foggy, home.</p>
